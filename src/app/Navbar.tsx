...
function Navbar() {
    ...
    return (
        <nav className="container mx-auto bg-amber-700 rounded-lg p-4 flex justify-between items-center relative z-20">
            ...
            <div className="flex items-center">
                <img
                    ...
                    className="h-16 w-16 rounded-full object-cover absolute border-amber-700 shadow-lg"
                />
                <div className="text-white font-bold text-2xl ml-20">
                    Mini Coffee
                </div>
            </div>
